  ...
  return (
    <div style={{width: "100%", minHeight: '100%', position: 'relative'}}>
      <div style={{margin: "80px 20px"}}>
        ...
        <div
          style={{
            display: "flex", gap: "10px", maxHeight: "600px",
          }}
        >
            ...
            <>
              ...
              <div style={{display: "flex", flexDirection: "column", maxWidth: "100%"}}>
                ...
                {frequencyAnalysis.length > 0 && (<div className='input_container'>
                  ...
                  <p className='input_description'>Выберите две буквы шифра, чтобы поменять их расшифровки местами.</p>
                ...
                {/* NEW (BIGRAM REPLACE) --- Глобальная замена биграмм */}
                {bigrams.length > 0 && (<div className='input_container'>
                  <p className='input_title'>Замена биграмм</p>
                  <p className='input_description'>Выберите биграмму и введите, на что заменить. Затем нажмите «Заменить все».</p>
                  <div className='input_mini-container'>
                    <div className='input_swappable'>
                      <div>
                ...
                {trigrams.length > 0 && (<div className='input_container'>
                  ...
                  <p className='input_description'>Выберите триграмму и введите, на что заменить. Затем нажмите «Заменить все».</p>
                  <div className='input_mini-container'>
                    <div className='input_swappable'>
                      <div>
